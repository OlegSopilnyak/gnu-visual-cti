...
Application server working with telephony hardware executing prepared and deployed to particular telephony-channel algorithms.<br/>Server instance is observed and managed through Java RMI from the Control Panel.
...
Tool allows to design develop and debug the application.<br/>
Developed application can be deployed to the application server directly.<br/>
Tool can connect to CTI Server's telephony channel in order to test developed algorithm using the real hardware.
