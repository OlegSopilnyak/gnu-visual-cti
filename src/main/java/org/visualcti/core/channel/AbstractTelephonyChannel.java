...
import org.visualcti.server.channel.ChannelTaskRunnerAdapter;

/**
 * The Abstract Telephony Channel: The channel through device of which task is communicating with computer telephony equipment
 *
        ...
        extends AbstractChannel<D> implements TelephonyChannel<D>
{
     ...
     * @see ChannelTaskRunnerAdapter#accept(DeviceEvent)
     * @see TelephonyChannel#isBusy()
     */
    @Override
    public boolean isBusy() {
        return TelephonyChannel.super.isBusy();
    }
