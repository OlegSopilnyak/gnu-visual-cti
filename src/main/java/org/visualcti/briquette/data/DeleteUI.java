 ...
 * <p>Description: The User Interface for adjust Delete</p>
...
public final class DeleteUI extends baseOperationUI
{
...
private final WhereUI where = new WhereUI();
  ...
  */
  ...
  protected final void assigned(Operation briquette) {
    if (briquette instanceof Delete) {
      this.owner=(Delete)briquette;
      this.table.reload();
      this.where.reload();
    }
  }
