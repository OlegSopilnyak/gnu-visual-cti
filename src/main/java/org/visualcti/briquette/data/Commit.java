 ...
 * <p>Description: To accept the changes in the DataSource</p>
...
public final class Commit extends Basis
{
    /**
     * <accessor>
     * To get access to new ID's prefix
     * */
    public final String get_ID_prefix(){return "Commit.";}
    /**
     * <constructor>
     * */
    public Commit(){super.setAbout("To commit changes");}
    /**
     * <accessor>
     ...
     * to do commit the changes for current connection
     * */
    protected final void dataMethod(Subroutine caller){
      try { super.context.database().commit();
      }catch(Exception e){}
    }
}
