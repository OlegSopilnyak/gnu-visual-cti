 ...
 * <p>Description: User's Interface for adjust Insert briquette</p>
...
public final class InsertUI extends baseOperationUI
{
...
private final SetUI set = new SetUI();
  ...
  */
  ...
  protected final void assigned(Operation briquette) {
    if (briquette instanceof Insert) {
      this.owner=(Insert)briquette;
      this.table.reload();
      this.set.reload();
    }
  }
