 ...
 * To adjust FileErase briquette</p>
...
public final class FileEraseUI extends baseOperationUI
{
...
private FileErase owner = null;
  ...
  public FileEraseUI()
  {
    ...
    this.params.add(Box.createVerticalStrut(4));
    UI_Store.addTitle( nameTitleText, this.params);
...
private volatile boolean isAssigned = false;
  ...
  protected final void assigned(Operation briquette) {
    if (briquette instanceof FileErase) {
      this.owner=(FileErase)briquette;
