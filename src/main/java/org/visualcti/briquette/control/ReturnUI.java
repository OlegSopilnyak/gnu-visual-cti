 ...
 * <p>Description: The User Iteraface for adjust Return briquette</p>
...
public class ReturnUI extends baseOperationUI
{
/**
 * <attribute>
 ...
 * The chooser
 * */
private JComboBox editor = new JComboBox(new Object[]{"true","false"});
/**
 * <const>
 * The title's text
 * */
private static final String titleText = "is drop a Call?";
  /**
   * <constructor>
  ...
  public ReturnUI()
  {
    JLabel title = new JLabel(ReturnUI.titleText,JLabel.CENTER);
  ...
  {
    if (briquette instanceof Return)
    {
      final Return operation = (Return)briquette;
      editor.setSelectedIndex(operation.isDropCall()?0:1);
//      ActionListener a[] = editor.getActionListeners();
      ...
      editor.addActionListener(new ActionListener(){
        ...
        {
          int index = ReturnUI.this.editor.getSelectedIndex();
          operation.setDropCall(index == 0);
        }
      });
    }
  }
