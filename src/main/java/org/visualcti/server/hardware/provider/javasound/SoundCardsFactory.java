 ...
 * @version 3.2
 */
public class SoundCardsFactory<H extends SoundCardHandle, D extends SoundCardDevice<H, ?>> extends AbstractTelephonyFactory<H, D> {
    protected SoundCardsFactory(Executor deviceEventsExecutor, TelephonyServiceProvider<H> provider) {
